...
- **cchm** — Cohen, Coquand, Huber, Mörtberg,
  *Cubical Type Theory: a constructive interpretation of the univalence
  axiom*, TYPES 2015 post-proceedings. arXiv:1611.02108.
...
- **chm-hits** — Coquand, Huber, Mörtberg, *On Higher Inductive Types in
  Cubical Type Theory*, LICS 2018. arXiv:1802.01170.
- **huber-canonicity** — Huber, *Canonicity for Cubical Type Theory*,
  J. Autom. Reasoning 2019. arXiv:1607.04156.
...
- **cubical-agda** — Vezzosi, Mörtberg, Abel, *Cubical Agda*, ICFP 2019
  (JFP 2021 extended version). Not on arXiv; author PDF fetched to
  `refs/misc/`. Library: repo **agda-cubical**.

## Cartesian cubical (contrast: no connections/De Morgan structure)

- **cart-cube** (repo) — Angiuli, Brunerie, Coquand, Hou (Favonia), Harper,
  Licata (ABCFHL), *Syntax and Models of Cartesian Cubical Type Theory*,
  MSCS 2021. Not on arXiv; the repo carries the PDF and an Agda
  formalization.
- **chtt3-univalent-universes** — Angiuli, Hou (Favonia), Harper,
  *Computational Higher Type Theory III*. arXiv:1712.01800. Closest arXiv
...
- **unifying-cubical-models** — Cavallo, Mörtberg, Swan, *Unifying Cubical
  Models of Univalent Type Theory*, CSL 2020. Not on arXiv; author PDF.
...
- **sterling-angiuli-normalization** — Sterling, Angiuli, *Normalization for
  Cubical Type Theory*, LICS 2021. arXiv:2101.11479.

## Interval algebra / cube categories

- **buchholtz-morehouse-varieties** — Buchholtz, Morehouse, *Varieties of
  Cubical Sets*, RAMiCS 2017. arXiv:1701.08189.
  Classifies cube categories by the algebraic theory on the interval; the
  natural place to situate a Kleene-lattice interval. nLab's "Kleene algebra"
  page cites it for cubical use of Kleene algebras.
...
- **cctt** (repo) — Kovács, efficient CCHM-style evaluator/typechecker.
...
- **smalltt** (repo) — Kovács, demo of fast elaboration for MLTT (glued
  evaluation, metavariables). No paper; README is the writeup.
- **elaboration-zoo** (repo) — Kovács, graded elaborator tutorials from
  bare NbE up to first-class implicits.
- **implicit-fun-elaboration** (repo) — Kovács, *Elaboration with
  First-Class Implicit Function Types*, ICFP 2020. Not on arXiv; the repo
  carries the paper source. The fix for cubicaltt's fatal usability gap.
- **kovacs-thesis-signatures** — Kovács, *Type-Theoretic Signatures for
  Algebraic Theories and Inductive Types* (PhD thesis). arXiv:2302.08837.
...
- **zhang-demorgan-tutorial** — Tesla Zhang, *A tutorial on implementing
  De Morgan cubical type theory*. arXiv:2210.08232. Third-party
  implementation walkthrough of the De Morgan flavor.
- *A hands-on introduction to cubicaltt* — blog tutorial,
  homotopytypetheory.org (2017). Not fetched; linked here for completeness.
