...
/-! `Stuff/Pi3JS2/Tubes.agda`, `Extensions.agda`: a tube is a partial
element on a cube's boundary varying along `x`; composing along it takes a
cube with the boundary at `0` to one at `1`, the star being the composite
of the constant cube. -/
...
-- The function underlying `2,2-diag-corollary2`.
